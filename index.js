...
//     randomiseNow('German', flashcardsGerman)
// }
...
function showAnswer(quizType, randomCardNumber) {
    if (document.getElementById(`randomQuestion${quizType}`).innerHTML == randomCardNumber.question) {
...
function showAnswerDutch() {
    showAnswer('Dutch', randomCardNumberDutch)
}
